...
<link href='https://unpkg.com/boxicons@2.1.1/css/boxicons.min.css' rel='stylesheet'>
      <form class="container" action="add_service_handle.php" method="post" enctype="multipart/form-data">
        <h1>Add Project</h1>
        <hr>
       ...
       <div class="sub-container">
        <label for="add Describe">Add Describe:</label>
         ...
         <small style="color: grey; font-size: 10px;">Supported formats: jpg, png, jpeg</small>
       </div>
